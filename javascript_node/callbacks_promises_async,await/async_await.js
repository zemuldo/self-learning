async function i_am_last_but_i_take_1_sec() {
...
async function i_am_fourth_but_i_take_4_sec() {
    return new Promise((resolve, reject)=>{
        setTimeout(() => {
...
async function i_am_third_but_i_take_6_sec() {
    return new Promise((resolve, reject)=>{
        setTimeout(() => {
...
async function i_am_second_but_i_take_8_sec() {
    return new Promise((resolve, reject)=>{
        setTimeout(() => {
...
async function i_am_first_but_i_take_10_sec() {
    return new Promise((resolve, reject)=>{
         setTimeout(() => {
